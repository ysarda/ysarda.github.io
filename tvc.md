...
<p>
	The crashcopter is a four propeller drone vehicle whose purpose is to fly, transport objects, have fun, and be a test of its builder's engineering skill. 
...
<h3>Problem Two: Unprofessional look</h3>
After the physical component of the device was made, my partner and I saw the crashcopter to be amateurish due to its exposed wires and plywood covers. A decision was made to swap plywood covers with an aluminum casing.
<h3>Problem Three: The Crash</h3>
During the third course test, the device flipped and crashed (hence the name). Two mounts were destroyed, a motor was broken, and an arm fell off. We worked with maximum productivity for the next two workdays to overcome the setback.

<h2>DEVOs</h2>
<h3>DEVO 1: Aluminum Casing</h3>
